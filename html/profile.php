...
<body style="background-color: rgb(238, 238, 238);">
    ...
    <div class="container" style="font-size: large;">
      ...
      <div class="col-sm-6">
          <h1 style="margin-left: 160px;" class="margin-bottom">View your profile</h1>

          <div class="form-group">
          <label class="control-label" for="formFirstName">First Name: </label>
          <input disabled type="text" class="form-control" id="formFirstName" placeholder="<?php echo $first_name ?>" />
          </div>

          <div class="form-group">
            <label class="control-label" for="formLastName">Last Name: </label>
            <input disabled type="text" class="form-control" id="formLastName" placeholder=<?php echo $last_name ?> />
          </div>

          <div class="form-group">
            <label class="control-label" for="formEmail">Email: </label>
            <input disabled type="email" class="form-control" id="formEmail" placeholder=<?php echo $email ?> />
          </div>

          <div class="form-group">
            <label class="control-label" for="formTeacherId">Teacher Id: </label>
            <input disabled type="text" class="form-control" id="formTeacherId" placeholder=<?php echo $teacher_id ?> />
          </div>

          <div class="row">
            <div class="col-sm-6">
              <a href="edit_profile.php" class="btn btn-warning btn-lg btn-block" role="button">Edit Profile</a>
            </div>

            <div class="col-sm-6">
              <a href="change_password.html" class="btn btn-warning btn-lg btn-block" role="button">Change Password</a>
            </div>
          </div>
